...
); // popup c редактированием профиля
...
//     .cloneNode(true); // клонировали c вложением
...
function main() {
  initialCards.forEach((element) => {
    // прошли по всем элементам массива
...
function openPopup(popupElement) {
  ...
  if (popupElement === popupEditProfileElement) {
    // если popup редактирования профиля
